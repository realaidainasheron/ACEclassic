    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("xp_modifier", new Property<double>(1.0, "Scales the amount of xp received by players, note that this stacks with the other xp_modifier options")),
                ...
                ("xp_modifier_reward_tier1", new Property<double>(1.0, "Scales the amount of xp received by players for completing quests while being under level 16")),
                ("xp_modifier_reward_tier2", new Property<double>(1.0, "Scales the amount of xp received by players for completing quests while being between level 16 and 36")),
